...
private fun LoginActionScreen(
    ...
    GradientBackground {
        Column(
            ...
            Text(
                text = stringResource(id = R.string.runmaster_welcome_text),
                fontSize = 12.sp,
            ...
            RunmasterActionButton(
                ...
                enabled = state.canLogin && !state.isLoginIn,
                onClick = {
...
@Preview
@Composable
private fun LoginActionScreenPreview() {
    RunmasterTheme {
        LoginActionScreen(
            state = LoginState(),
            onAction = {}
